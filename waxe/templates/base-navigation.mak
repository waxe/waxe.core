  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    ...
    <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-icons">
              ...
              % endif
              <li><a title="Open" data-cache="cache.open" data-href="${request.custom_route_path('open_json')}" href="#"><i class="fa fa-folder-open-o"></i>Open</a></li>
              <li class="disabled"><a title="Save" class="save" data-call="navbar.save" href="#"><i class="fa fa-save"></i>Save</a></li>
              <li><a class="saveas" title="Save as" data-cache="cache.saveas" data-href="${request.custom_route_path('saveas_json')}" href="#"><i class="fa fa-save"></i>Save as</a></li>
      ...
      <ul class="nav navbar-nav navbar-icons">
        ...
        <li><a class="fa fa-folder-open-o" title="Open" data-cache="cache.open" data-href="${request.custom_route_path('open_json')}" href="#"></a></li>
