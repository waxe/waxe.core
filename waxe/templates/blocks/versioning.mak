...
% if files_data:
  <form class="diff" data-action="${request.custom_route_path('versioning_dispatcher_json', method='diff')}" action="${request.custom_route_path('versioning_dispatcher', method='diff')}" method="GET">
